...
def build_ask_prompt(
    ...
    prompt_parts.extend(
        [
            ...
            "- OVERWHELM RULE: If the user has said 'i dont know', 'guide me', 'all', 'everything', or any variation of \"I can't choose\" in response to a priority question — and you have already asked a clarifying question once — DO NOT ask again. Instead, commit to a concrete answer. Make a decision for them. Give a numbered list of 1-3 specific, actionable next steps based on what you know from their journal and memory. Do not hedge. Do not ask what they want to focus on. Just tell them what to do next, ordered by urgency. You are a thoughtful friend who has read their journal — act like one.",
            ...
            "- FOLLOW-UP RULE: When the user shares feelings or asks a vague question, ask ONE thoughtful follow-up question. Not two. Not zero. Exception: if OVERWHELM RULE applies, skip the follow-up question entirely and commit to a concrete answer instead.",
        ]
    )
